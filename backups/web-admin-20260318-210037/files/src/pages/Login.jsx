...
function Login({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const token = loginResponse?.token || loginResponse?.access_token || loginResponse?.accessToken || ''
      const user = loginResponse?.user || null

      if (!token || !user) {
        throw new Error('Neplatná odpoveď zo servera pri prihlásení')
      }
            ...
            <label className="checkbox-label">
              ...
              <span
                ...
                style={{
                  ...
                  borderRadius: '2px',
                  background: rememberMe ? '#ff6b00' : '#2a2a2a',
